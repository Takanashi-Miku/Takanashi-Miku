...
var TouchSlide = function(a) {
		...
		/*自定义方法 设置 公用跳转地址*/
		var seturl = function(ele){
			var a = ele.getElementsByTagName("a");
			if(a.length>0){
				var url = ele.childNodes[0].getAttribute("href");
			}
			var tag = ele.parentNode.getElementsByTagName("span")[0];
			console.log(tag);
			if(tag){
				tag.childNodes[0].setAttribute("href",url);
			}
		}
